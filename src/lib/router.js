...
//   #/media  #/search  #/lockbin  #/settings  #/tokens  #/following
//   #/print/entry/2026-09-10   #/print/month/2026-09   printable pages for Save as PDF
...
export function parseRoute(path = read()) {
  ...
  if (a === 'print') return { name: 'print', kind: b === 'month' ? 'month' : 'entry', param: c ?? null }
